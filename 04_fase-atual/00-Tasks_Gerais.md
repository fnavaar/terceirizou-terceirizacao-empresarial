...
**Atualizada em:** 2026-09-17 · Run transição F3→F4 · Champion: Vinicius · Prazo da fase: 30/09/2026
...
|---|---|---|---|---|---|---|---|
| e4c77e80 | Confirmar com o Cliente o acesso de leitura à conta do Meta | Izabel | SPEC-4-001 | B4-101 | nenhum | 22/09/2026 | `[ ]` ELEGÍVEL |
| cd704a1c | Trazer para o CRM a origem, a campanha e o anúncio de cada lead | Cliente | SPEC-4-001 | CA-4-101/102/103/104 | e4c77e80 | 24/09/2026 | `[ ]` |
...
- B4-101..104 (SPEC-4-001): conta Meta, credencial no cofre, escopos, amostra/período — champion Vinicius + prova técnica.
